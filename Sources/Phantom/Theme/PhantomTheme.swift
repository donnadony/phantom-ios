...
public struct PhantomTheme {
    ...
    public static let kodivex = PhantomTheme(
        ...
        surface: Color(hex: "#1c2540"),
        surfaceVariant: Color(hex: "#283050"),
        onBackground: Color(hex: "#e4ecff"),
        onBackgroundVariant: Color(hex: "#a8b4d0"),
        ...
        outlineVariant: Color(hex: "#5a5570"),
    ...
    public init(
        ...
        surface: Color = Color(hex: "#1c2540"),
        surfaceVariant: Color = Color(hex: "#283050"),
        onBackground: Color = Color(hex: "#e4ecff"),
        onBackgroundVariant: Color = Color(hex: "#a8b4d0"),
        ...
        outlineVariant: Color = Color(hex: "#5a5570"),
